...
#===============================================================================
#
#          FILE: chatGPT-WEB_el8.sh
# 
#         USAGE: ./chatGPT-WEB_el8.sh
#
...
if which nginx &>/dev/null; then
  ...
  wget http://nginx.org/packages/centos/8/x86_64/RPMS/nginx-1.22.1-1.el8.ngx.x86_64.rpm &>/dev/null
  dnf -y install nginx-1.22.1-1.el8.ngx.x86_64.rpm 2>&1 >/dev/null | grep -E "error|fail|warning"
  echo "Nginx installed."
  rm -f nginx-1.22.1-1.el8.ngx.x86_64.rpm
fi
...
pnpm install googleapis 2>&1 >/dev/null | grep -E "error|fail|warning"
# 打包
